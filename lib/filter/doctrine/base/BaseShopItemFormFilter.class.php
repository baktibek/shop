...
/**
 * ShopItem filter form base class.
 *
 * @package    shops
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseShopItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('shop_item_filters[%s]');
